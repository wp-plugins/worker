 ...
 * @author Google, Inc.
 */
class Google_Service_Tasks extends Google_ApiService
{
  /** Manage your tasks. */
...
class Google_Service_Tasks_TaskLinks extends Google_ApiModel
{
  public $description;
  public $link;
  public $type;
...
class Google_Service_Tasks_TaskList extends Google_ApiModel
{
  public $etag;
  public $id;
  public $kind;
