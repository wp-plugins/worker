...
final class S3_Request
{
    ...
    public function getResponse()
    {
        ...
        if (S3_Client::$useSSL)
        {
            ...
            if (S3_Client::$sslKey !== null) curl_setopt($curl, CURLOPT_SSLKEY, S3_Client::$sslKey);
            if (S3_Client::$sslCert !== null) curl_setopt($curl, CURLOPT_SSLCERT, S3_Client::$sslCert);
            if (S3_Client::$sslCACert !== null) curl_setopt($curl, CURLOPT_CAINFO, S3_Client::$sslCACert);
        }
